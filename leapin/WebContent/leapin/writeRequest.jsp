...
<header id="header-area">
	<div class="header-left">
		...
		<div class="h-left2">
			<ul>
				...
				<li><button type="button" class="right-heaeder-button-group" id="btn_search_receive_offer" onClick="location.href='일반회원_받은견적.jsp';">견적</button></li>
				<li><button type="button" class="right-heaeder-button-group" id="btn_search_receive_request" onClick="location.href='기업회원_받은요청.jsp';">요청</button></li>
			</ul>
		</div>
	</div>
	<div class="header-right">
		...
		<button id="btn_board" class="heaeder-button-group" onclick="location.href='http://localhost:9090/ProjectWeb1/Controller?command=Board';">게시판 보기</button>
...
<section class = "container">
		<h1 class ="page-heading-h1">요청서 작성</h1>
			...
			<div class = "body-button-left">
				<div style = "display:flex; margin-top:10px;">
					<span style= "font-size:20px; margin-right:5px;">첨부파일 : </span>
			...
			<button type = "submit" class = "btn btn-primary" id = "send-request" style = "float:right; margin-top:-35px;">보내기</button>
